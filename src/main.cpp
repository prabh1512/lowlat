...
int main(int argc, char* argv[]) {
    ...
    lowlat::book::OrderBook<lowlat::book::CommodityBookV3> book;
    lowlat::book::BookHandler<lowlat::book::CommodityBookV3> handler(book);
    ...
    dump_vector("bench-results/cb_add_cycles.bin", lowlat::book::CommodityBookV3::add_cycles);
    dump_vector("bench-results/cb_reduce_cycles.bin", lowlat::book::CommodityBookV3::reduce_cycles);
